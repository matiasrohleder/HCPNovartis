...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HCP Novartis API", Version = "v1" });
...
var port = Environment.GetEnvironmentVariable("PORT") ?? builder.Configuration.GetSection("ServerConfiguration")["Port"] ?? "5002";
